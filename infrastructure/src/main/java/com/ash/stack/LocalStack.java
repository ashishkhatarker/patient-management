    ...
    public LocalStack(final App scope, final String id, final StackProps props){
        ...
        FargateService authService =
                createFargateService("AuthService",
                        ...
                        List.of(4005),
                        authServiceDb,
                        Map.of("JWT_SECRET", "503cd3ce3a940e9e91010256e1206342793e8582d8064946df84aec192cd54ce"));
    ...
    private FargateService createFargateService(String id,
        ...
        if(db != null){
            ...
            envVars.put("SPRING_DATASOURCE_PASSWORD",
                    db.getSecret().secretValueFromJson("praneel").toString());
            envVars.put("SPRING_JPA_HIBERNATE_DDL_AUTO", "update");
            envVars.put("SPRING_SQL_INIT_MODE", "always");
            envVars.put("SPRING_DATASOURCE_HAKARI_INTIALIZATION_FAIL_TIMEOUT", "60000");
        }
